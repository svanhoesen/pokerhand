/*
 * Program: Card.java
 * Origional Author: Mercer
 * Sub Author: Steffan Van Hoesen
 * Project 01
 */
...
/**
 * Model one Poker Card.  Since Card implements Comparable<Card>, a list
 * if these can be sorted
 * 
 * @author mercer
 *
 */
public class Card implements Comparable<Card> {
  ...
  @Override
  // Return true if other is a non null Card object with the smae
